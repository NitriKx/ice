## Find our SaaS version here: [https://teevity.com](https://teevity.com)
\*\*WARNING\*\* To test the latest version of Teevity Ice, you need to create an account on [https://teevity.com](https://teevity.com) and use our SaaS version (i.e. hosted version). We will also release in S2 2016, an AWS Marketplace version (called Teevity Incognito) which will let you start Teevity Ice on your own AWS account. This repository is outdated and does not represent at all the latest version of Teevity Ice.
